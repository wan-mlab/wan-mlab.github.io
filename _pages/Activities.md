...
## AACR - 2025
<strong>Mengtao</strong> presents two posters: "iS<sub>3</sub>RGs: Discriminating diverse medulloblastoma subtypes by leveraging heterogenous transcriptome data with batch effects" and "Identifying pancreatic cancer subtypes by a novel meta-learning model". <strong>Xinchao</strong> presents three posters: "Combining random projection and stacking learning for NSCLC subtype classification based on transcriptomic data", "Identifying pancreatic cancer subtypes by a novel meta-learning model" and "AttentionAML: An attention-based deep learning model for accurate identification of childhood acute myeloid leukemia subtypes". 
</div>
<div class="col-sm-9">
<div markdown="0" id="carousel3" class="carousel slide" data-ride="carousel" data-interval="4000" data-pause="hover" >
    ...
    <div class="carousel-inner" markdown="0">
        <div class="item active">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/AACR20251.png" alt="Slide 1" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/AACR20252.png" alt="Slide 2" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/AACR20253.png" alt="Slide 3" />
        </div>
    </div>
