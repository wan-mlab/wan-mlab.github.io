...
<div class="col-sm-9">
<div markdown="0" id="carousel7a" class="carousel slide" data-ride="carousel" data-interval="4000" data-pause="hover" >
    <!-- Menu -->
    <ol class="carousel-indicators">
        <li data-target="#carousel7a" data-slide-to="0" class="active"></li>
        <li data-target="#carousel7a" data-slide-to="1"></li>
        <li data-target="#carousel7a" data-slide-to="2"></li>
    </ol>

    <!-- Items -->
    <div class="carousel-inner" markdown="0">
        <div class="item active">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/OA1.JPG" alt="Slide 1" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/OA2.jpeg" alt="Slide 2" />
        </div>
    </div>
  <a class="left carousel-control" href="#carousel7a" role="button" data-slide="prev">
    <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
    <span class="sr-only">Previous</span>
  </a>
  <a class="right carousel-control" href="#carousel7a" role="button" data-slide="next">
...
<br>
<div id="textid" class="col-sm-12">
## Congratulations to Nick for officially graduating from UNMC
</div>
<div class="col-sm-9">
<div markdown="0" id="carousel19" class="carousel slide" data-ride="carousel" data-interval="4000" data-pause="hover" >
    <!-- Menu -->
    <ol class="carousel-indicators">
        <li data-target="#carousel19" data-slide-to="0" class="active"></li>
        <li data-target="#carousel19" data-slide-to="1"></li>
        <li data-target="#carousel19" data-slide-to="2"></li>
        <li data-target="#carousel19" data-slide-to="3"></li>
        <li data-target="#carousel19" data-slide-to="4"></li> 
        <li data-target="#carousel19" data-slide-to="5"></li>
        <li data-target="#carousel19" data-slide-to="6"></li>
        <li data-target="#carousel19" data-slide-to="7"></li>          
    </ol>

    <!-- Items -->
    <div class="carousel-inner" markdown="0">
         <div class="item active">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/nick1.jpeg" alt="Slide 1" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/nick2.jpeg" alt="Slide 2" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/nick3.jpeg" alt="Slide 3" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/nick4.jpeg" alt="Slide 4" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/nick5.jpeg" alt="Slide 5" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/nick6.jpeg" alt="Slide 6" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/nick7.jpeg" alt="Slide 7" />
        </div>          
    </div>
  <a class="left carousel-control" href="#carousel19" role="button" data-slide="prev">
    <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
    <span class="sr-only">Previous</span>
  </a>
  <a class="right carousel-control" href="#carousel19" role="button" data-slide="next">
    <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
    <span class="sr-only">Next</span>
  </a>
</div>
...
<br>  
<div id="textid" class="col-sm-12">
## AI in Health Conference 2026
</div>
<div class="col-sm-9">
<div markdown="0" id="carousel18" class="carousel slide" data-ride="carousel" data-interval="4000" data-pause="hover" >
    <!-- Menu -->
    <ol class="carousel-indicators">
        <li data-target="#carousel18" data-slide-to="0" class="active"></li>
        <li data-target="#carousel18" data-slide-to="1"></li>
        <li data-target="#carousel18" data-slide-to="2"></li>
    </ol>

    <!-- Items -->
    <div class="carousel-inner" markdown="0">
         <div class="item active">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/IMG_0870.jpeg" alt="Slide 1" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/IMG_0875.jpeg" alt="Slide 2" />
        </div>
    </div>
  <a class="left carousel-control" href="#carousel18" role="button" data-slide="prev">
    <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
    <span class="sr-only">Previous</span>
  </a>
  <a class="right carousel-control" href="#carousel18" role="button" data-slide="next">
    <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
    <span class="sr-only">Next</span>
  </a>
</div>
...
<br>  
<div id="textid" class="col-sm-12">
## Congratulations to <b>Nick</b> for successfully defending his thesis!
</div>
<div class="col-sm-9">
<div markdown="0" id="carousel17" class="carousel slide" data-ride="carousel" data-interval="4000" data-pause="hover" >
    <!-- Menu -->
    <ol class="carousel-indicators">
        <li data-target="#carousel17" data-slide-to="0" class="active"></li>
        <li data-target="#carousel17" data-slide-to="1"></li>
        <li data-target="#carousel17" data-slide-to="2"></li>
        <li data-target="#carousel17" data-slide-to="3"></li>
    </ol>

    <!-- Items -->
    <div class="carousel-inner" markdown="0">
         <div class="item active">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/nick_defense1.jpeg" alt="Slide 1" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/nick_defense2.jpeg" alt="Slide 2" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/nick_defense3.jpeg" alt="Slide 3" />
        </div>
    </div>
  <a class="left carousel-control" href="#carousel17" role="button" data-slide="prev">
    <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
    <span class="sr-only">Previous</span>
  </a>
  <a class="right carousel-control" href="#carousel17" role="button" data-slide="next">
    <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
    <span class="sr-only">Next</span>
  </a>
</div>
...
<div class="col-sm-9">
<div markdown="0" id="carousel15" class="carousel slide" data-ride="carousel" data-interval="4000" data-pause="hover" >
    <!-- Menu -->
    <ol class="carousel-indicators">
        <li data-target="#carousel15" data-slide-to="0" class="active"></li>
        <li data-target="#carousel15" data-slide-to="1"></li>
        <li data-target="#carousel15" data-slide-to="2"></li>
        <li data-target="#carousel15" data-slide-to="3"></li>        
    </ol>

    <!-- Items -->
    <div class="carousel-inner" markdown="0">
        <div class="item active">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/IMG_1428.jpeg" alt="Slide 1" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/IMG_1425.jpeg" alt="Slide 2" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/IMG_1419.jpeg" alt="Slide 3" />
        </div>        
    </div>
  <a class="left carousel-control" href="#carousel15" role="button" data-slide="prev">
    <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
    <span class="sr-only">Previous</span>
  </a>
  <a class="right carousel-control" href="#carousel15" role="button" data-slide="next">
    <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
    <span class="sr-only">Next</span>
  </a>
</div>
...
<div markdown="0" id="carousel13" class="carousel slide" data-ride="carousel" data-interval="4000" data-pause="hover" >
    <!-- Menu -->
    <ol class="carousel-indicators">
        <li data-target="#carousel13" data-slide-to="0" class="active"></li>
        <li data-target="#carousel13" data-slide-to="1"></li>
        <li data-target="#carousel13" data-slide-to="2"></li>
        <li data-target="#carousel13" data-slide-to="3"></li>
        <li data-target="#carousel13" data-slide-to="4"></li>
    </ol>

    <!-- Items -->
    <div class="carousel-inner" markdown="0">
         <div class="item active">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/fan1.jpeg" alt="Slide 1" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/fan2.jpeg" alt="Slide 2" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/fan3.jpeg" alt="Slide 3" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/fan4.jpeg" alt="Slide 4" />
        </div>
    </div>
  <a class="left carousel-control" href="#carousel13" role="button" data-slide="prev">
    <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
    <span class="sr-only">Previous</span>
  </a>
  <a class="right carousel-control" href="#carousel13" role="button" data-slide="next">
    <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
    <span class="sr-only">Next</span>
  </a>
</div>
...
<div markdown="0" id="carousel7a" class="carousel slide" data-ride="carousel" data-interval="4000" data-pause="hover" >
    ...
    <div class="carousel-inner" markdown="0">
        <div class="item active">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/party2025.jpeg" alt="Slide 1" />
        </div>
    </div>
  <a class="left carousel-control" href="#carousel7a" role="button" data-slide="prev">
    <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
...
<br>
<div id="textid" class="col-sm-12">
## Congratulations to <b>Hanyu</b> for officially graduating from UNMC
</div>
<div class="col-sm-9">
<div markdown="0" id="carousel12" class="carousel slide" data-ride="carousel" data-interval="4000" data-pause="hover" >
    <!-- Menu -->
    <ol class="carousel-indicators">
        ...
        <li data-target="#carousel12" data-slide-to="5"></li>
        <li data-target="#carousel12" data-slide-to="6"></li>
        <li data-target="#carousel12" data-slide-to="7"></li>
    </ol>
  ...
  <a class="left carousel-control" href="#carousel12" role="button" data-slide="prev">
    <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
    <span class="sr-only">Previous</span>
  </a>
  <a class="right carousel-control" href="#carousel12" role="button" data-slide="next">
    <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
    <span class="sr-only">Next</span>
  </a>
</div>
...
<div class="col-sm-9">
<div markdown="0" id="carousel11" class="carousel slide" data-ride="carousel" data-interval="4000" data-pause="hover" >
    <!-- Menu -->
    <ol class="carousel-indicators">
        ...
        <li data-target="#carousel11" data-slide-to="4"></li>
        <li data-target="#carousel11" data-slide-to="5"></li>
        <li data-target="#carousel11" data-slide-to="6"></li>
        <li data-target="#carousel11" data-slide-to="7"></li>
        <li data-target="#carousel11" data-slide-to="8"></li>
        <li data-target="#carousel11" data-slide-to="9"></li>
        <li data-target="#carousel11" data-slide-to="10"></li>
    </ol>
  ...
  <a class="left carousel-control" href="#carousel11" role="button" data-slide="prev">
    <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
    <span class="sr-only">Previous</span>
  </a>
  <a class="right carousel-control" href="#carousel11" role="button" data-slide="next">
    <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
    <span class="sr-only">Next</span>
  </a>
</div>
...
<div markdown="0" id="carousel10" class="carousel slide" data-ride="carousel" data-interval="4000" data-pause="hover" >
    ...
    <ol class="carousel-indicators">
        ...
        <li data-target="#carousel10" data-slide-to="4"></li>  
        <li data-target="#carousel10" data-slide-to="5"></li> 
        <li data-target="#carousel10" data-slide-to="6"></li>
        <li data-target="#carousel10" data-slide-to="7"></li>
        <li data-target="#carousel10" data-slide-to="8"></li>
        <li data-target="#carousel10" data-slide-to="9"></li>
        <li data-target="#carousel10" data-slide-to="10"></li>
        <li data-target="#carousel10" data-slide-to="11"></li>
        <li data-target="#carousel10" data-slide-to="12"></li>
    </ol>

    <!-- Items -->
    <div class="carousel-inner" markdown="0">
        <div class="item active">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/hy1.jpeg" alt="Slide 1" />
        </div>
         <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/hy2.jpeg" alt="Slide 2" />
        </div>  
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/hy3.jpeg" alt="Slide 3" />
        </div>  
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/hy4.jpeg" alt="Slide 4" />
        </div>  
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/hy5.jpeg" alt="Slide 5" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/hy6.jpeg" alt="Slide 6" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/hy7.jpeg" alt="Slide 7" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/hy8.jpeg" alt="Slide 8" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/hy9.jpeg" alt="Slide 9" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/hy10.jpeg" alt="Slide 10" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/hy11.jpeg" alt="Slide 11" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/Activities/hy12.jpeg" alt="Slide 12" />
        </div>
    </div>
  <a class="left carousel-control" href="#carousel10" role="button" data-slide="prev">
    <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
    <span class="sr-only">Previous</span>
  </a>
  <a class="right carousel-control" href="#carousel10" role="button" data-slide="next">
    <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
    <span class="sr-only">Next</span>
  </a>
</div>
...
<div markdown="0" id="carousel9" class="carousel slide" data-ride="carousel" data-interval="4000" data-pause="hover" >
    ...
    <ol class="carousel-indicators">
        ...
        <li data-target="#carousel9" data-slide-to="4"></li>  
        <li data-target="#carousel9" data-slide-to="5"></li> 
        <li data-target="#carousel9" data-slide-to="6"></li>
        <li data-target="#carousel9" data-slide-to="7"></li>
        <li data-target="#carousel9" data-slide-to="8"></li>
        <li data-target="#carousel9" data-slide-to="9"></li>
  ...
  <a class="right carousel-control" href="#carousel9" role="button" data-slide="next">
    <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
    <span class="sr-only">Next</span>
  </a>
</div>
